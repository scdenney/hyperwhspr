Review recent hyprwhspr transcription cleanup logs and update the vocabulary/style file.

## What to do

Read these two files:

- `~/.config/hyprwhspr/cleanup_log.jsonl` - JSONL log of `{ts, raw, cleaned}` pairs
- `~/.config/hyprwhspr/vocab.md` - current vocabulary and style preferences
...
`~/.config/hyprwhspr/vocab.md` with all approved changes incorporated.
